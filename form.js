(function() {
    ...
    const colorPreviewImages = {
        'default': 'https://your-domain.com/images/sailboat-preview.jpg',
        'green': 'https://your-domain.com/images/mossy-preview.jpg',
        'gold': 'https://your-domain.com/images/golden-preview.jpg',
        'rhubarb': 'https://your-domain.com/images/rhubarb-preview.jpg'
    };
    
    function updateColorPreview(color) {
        const previewContainer = document.getElementById('colorPreview');
        if (previewContainer && colorPreviewImages[color]) {
            previewContainer.style.backgroundImage = `url('${colorPreviewImages[color]}')`;
        }
    }
